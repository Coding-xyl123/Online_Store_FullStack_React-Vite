...
const ManageBooks = () => {
  ...
  const handleDeleteBook = async (id) => {
    console.log("Deleting book with id:", id); // Add logging
    try {
      ...
      console.error("Failed to delete book:", error); // Log the entire error object
